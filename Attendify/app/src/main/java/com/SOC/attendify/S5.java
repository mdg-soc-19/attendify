...
public class S5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        save=(Button) findViewById(R.id.button38) ;
        save.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View view) {
                                        ...
                                        mDatabase.child("Present5").setValue(a);
                                        mDatabase.child("total5").setValue(b);
                                        ...
                                        Intent I=new Intent(S5.this,Stats_1_Activity.class);
                                        startActivity(I);
        ...
        t=(TextView) findViewById(R.id.textView38);
        ...
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                converta = dataSnapshot.child("Present5").getValue().toString();
                convertb=  dataSnapshot.child("total5").getValue().toString();
                s=  dataSnapshot.child("Subject 5").getValue().toString();
                t.setText(s);
